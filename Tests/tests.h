...
unsigned char Date[];
public:
    Tests(hwlib::i2c_bus_bit_banged_scl_sda & i2c, const uint8_t chipaddres, unsigned char Date[],
    int testDay=Day, int testMonth=Month, int testYear=Year,unsigned char Bin=binValue, 
